    ...
    <main className="text-text relative">
      ...
      <section className="relative min-h-screen flex items-center justify-center px-6 pt-24">
        <div className="mx-auto max-w-5xl text-center">
          <div className="rounded-3xl border border-line/40 bg-black/70 backdrop-blur-md p-12 md:p-16">
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
              <button className="rounded-full border border-accent/60 bg-accent/20 px-8 py-4 text-base font-medium text-accent transition hover:bg-accent/30">
                Book a Demo
              </button>
              <button className="rounded-full border border-line/60 bg-black/40 px-8 py-4 text-base font-medium text-text transition hover:bg-black/60">
                Join the Platform
              </button>
            </div>
          </div>
      ...
      <section id="features" className="mx-auto w-full max-w-6xl px-6 py-32">
        <div className="mb-16 rounded-2xl border border-line/40 bg-black/50 backdrop-blur-sm p-8 inline-block">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {features.map((feature, index) => (
            <div
              key={index}
              className="rounded-2xl border border-line/50 bg-black/80 backdrop-blur-md p-8 hover:bg-black/90 transition-colors"
            >
      ...
      <section className="mx-auto w-full max-w-6xl px-6 py-24">
        <div className="rounded-3xl border border-accent/40 bg-black/80 backdrop-blur-md p-12 md:p-20 text-center">
      ...
      <section id="platform" className="mx-auto w-full max-w-6xl px-6 py-32">
        <div className="mb-16 rounded-2xl border border-line/40 bg-black/50 backdrop-blur-sm p-8">
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          {platform.map((item, index) => (
            <div
              key={index}
              className="rounded-xl border border-line/50 bg-black/80 backdrop-blur-md p-6 hover:bg-black/90 transition-colors"
            >
      ...
      <section id="analytics" className="mx-auto w-full max-w-6xl px-6 py-32">
        ...
        <div className="space-y-6">
          <div className="rounded-2xl border border-line/50 bg-black/80 backdrop-blur-md p-8 md:p-12">
      ...
      <section id="cta" className="mx-auto w-full max-w-4xl px-6 py-32 text-center">
        <div className="rounded-3xl border border-accent/40 bg-black/80 backdrop-blur-md p-12 md:p-16">
      ...
      {/* Footer */}
      <footer className="border-t border-line/30 bg-black/70 backdrop-blur-sm">
